...
import com.nakharin.wongfah.adapter.MenuScreenAdapter
...
class MenuScreenFragment: Fragment() {
    ...
    private lateinit var recyclerMenuScreen: RecyclerView

    private lateinit var menuScreenAdapter: MenuScreenAdapter
    ...
    private fun initInstances(rootView: View, savedInstanceState: Bundle?) {
        ...
        recyclerMenuScreen = rootView.findViewById(R.id.recyclerMenuScreen)
        val linearLayoutManager = LinearLayoutManager(rootView.context, OrientationHelper.HORIZONTAL, false)
        recyclerMenuScreen.layoutManager = linearLayoutManager

        menuScreenAdapter = MenuScreenAdapter(menuList)
        recyclerMenuScreen.adapter = menuScreenAdapter
    }
        ...
        val service = ConnectionService.getApiService().getCategoryList()
                ...
                .subscribe({
                    ...
                    if (it.success) {
                        ...
                        recyclerMenuScreen.adapter.notifyDataSetChanged()
                    } else {
